                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($records as $department)
                        <tr class="hover:bg-navy-tint/50 transition">
                            <td class="px-5 py-3.5 font-bold text-ink">{{ $department->name }}</td>
                            ...
                            <td class="px-4 py-3.5 text-ink-soft">{{ $department->office?->name ?? '—' }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-5 py-12 text-center text-ink-muted">Belum ada data bagian.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
